...
module fifo_synth(CLK, ENB, RST, sRead, sWrite, umbEmpty, umbFull, inputData, almostEmpty, almostFull, outEmpty, outFull, errorEmpty, errorFull, outputData);
  ...
  assign _037_[1] = _144_[2] & _141_[31];
  ...
  assign _155_[31] = umbFull[2] |(* src = "<techmap.v>:260|<techmap.v>:221" *)  _172_;
  ...
  assign _038_[7] = _037_[15] &(* src = "<techmap.v>:260|<techmap.v>:222" *)  _037_[15];
  ...
  assign _014_[3] = cantWr[2] &(* src = "<techmap.v>:260|<techmap.v>:221" *)  _127_[1];
